...
export const negotiateCampaign = (id, data) => api.post(`/api/campaign/${id}/negotiate`, data);
export const acceptNegotiationOffer = (id) => api.put(`/api/campaign/${id}/accept-offer`);

...
const Footer = () => {
  return (
    <footer className="bg-[var(--color-navy)] pt-20 pb-8 relative overflow-hidden border-t border-white/10">
      ...
      <div className="container mx-auto px-6 md:px-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li><a href="#" className="text-white/60 hover:text-white transition-colors text-sm">For Creators</a></li>
              <li><a href="#" className="text-white/60 hover:text-white transition-colors text-sm">For Brands</a></li>
              <li><a href="#" className="text-white/60 hover:text-white transition-colors text-sm">Escrow Flow</a></li>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li><a href="#" className="text-white/60 hover:text-white transition-colors text-sm">Escrow Agreement</a></li>
            </ul>
          </div>
        ...
        <div className="pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-white/40 text-sm">
            &copy; {new Date().getFullYear()} Gradix Inc. All rights reserved.
          </p>

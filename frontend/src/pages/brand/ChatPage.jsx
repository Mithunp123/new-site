// Brand chat page — reuses the same full-page layout as creator ChatPage
// but imports from brand-specific auth hook
          ...
          <div className="flex-1 overflow-y-auto">
            {filteredConvs.length === 0 ? (
              <div className="flex flex-col items-center justify-center h-full text-slate-400 p-8 text-center">
                ...
                <p className="text-xs mt-1 text-slate-400">Accept a creator request to start chatting</p>
              </div>
            ) : (

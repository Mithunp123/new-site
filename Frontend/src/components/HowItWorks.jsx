...
const ScatterStars = () => (
  <div className="flex justify-center mb-6 relative w-16 h-12 mx-auto">
    <svg width="100%" height="100%" viewBox="0 0 60 40" fill="none" className="text-[var(--color-navy)]">
  ...
  return (
    <section className="py-24 bg-[var(--color-bg-alt)] overflow-hidden">
      <div className="container mx-auto px-6 md:px-12 text-center mb-20">
        ...
        >
          <ScatterStars />
          <h2 className="text-4xl md:text-5xl font-bold text-[var(--color-navy)] mb-6 tracking-tight">
            The Gradix Escrow Guarantee.
          </h2>
          <p className="text-lg md:text-xl text-[var(--color-text)]/60 max-w-2xl mx-auto font-medium">
            ...
            <div key={i} className="relative flex flex-col items-center text-center">
                ...
                <>
                  ...
                  <div className="hidden md:block absolute w-[50%] right-[50%] top-2 h-12 z-[-1] opacity-30">
                    <svg width="100%" height="100%" viewBox="0 0 100 100" preserveAspectRatio="none">
                      <path d="M 0,0 Q 50,100 100,100" fill="none" stroke="var(--color-text)" strokeWidth="2" strokeDasharray="6 6" vectorEffect="non-scaling-stroke" />
                    </svg>
                  </div>
                  {/* Line from 1 to 2 */}
                  <div className="hidden md:block absolute w-full left-[50%] top-14 h-12 z-[-1] opacity-30">
                    <svg width="100%" height="100%" viewBox="0 0 100 100" preserveAspectRatio="none">
                      <path d="M 0,0 Q 50,100 100,0" fill="none" stroke="var(--color-text)" strokeWidth="2" strokeDasharray="6 6" vectorEffect="non-scaling-stroke" />
                    </svg>
                  </div>
                </>
              )}
              {i === 1 && (
                ...
                <div className="hidden md:block absolute w-full left-[50%] top-2 h-12 z-[-1] opacity-30">
                  <svg width="100%" height="100%" viewBox="0 0 100 100" preserveAspectRatio="none">
                    <path d="M 0,100 Q 50,0 100,100" fill="none" stroke="var(--color-text)" strokeWidth="2" strokeDasharray="6 6" vectorEffect="non-scaling-stroke" />
                  </svg>
                </div>
              )}
              {i === 2 && (
              ...
              >
                ...
                <div className={`w-28 h-28 rounded-full flex items-center justify-center relative z-10 bg-white transition-all duration-300 ${
                  step.active 
                    ...
                    : 'border-2 border-dashed border-[var(--color-text)]/20'
                }`}>
              ...
              >
                <h3 className="text-xl font-bold text-[var(--color-navy)] mb-3">{step.title}</h3>
                <p className="text-[var(--color-text)]/70 text-sm leading-relaxed max-w-[240px] mx-auto">
                  {step.desc}
                </p>
              </motion.div>
            </div>
